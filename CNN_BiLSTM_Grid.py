...
# 构建模型的函数
def create_model(optimizer='RMSprop', dropout=0.0):
    # cleanup
    ...
    model.add(Dropout(dropout))  # 随机失活
...
model = KerasClassifier(build_fn=create_model, epochs=33, batch_size=64, verbose=1)
# 定义网格搜索参数
